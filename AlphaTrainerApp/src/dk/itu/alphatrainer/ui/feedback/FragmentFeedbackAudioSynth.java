...
public class FragmentFeedbackAudioSynth extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.fragment_feedback_audio_synth, container, false);
		
		// Call back parent activity with this fragments root view
		((IActivityFeedbackUi) getActivity()).onFragmentViewCreated(root);
		
		// Setup font
		UiUtils.changeFonts((ViewGroup) root.findViewById(R.id.layout_feedback_audio_synth_root));
