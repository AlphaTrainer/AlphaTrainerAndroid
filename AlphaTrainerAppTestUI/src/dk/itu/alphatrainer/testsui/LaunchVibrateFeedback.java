 ...
 */
public class LaunchVibrateFeedback extends UiAutomatorTestCase {
...
brainAppSettingsSelectTypeOfFeedbackUI.click();
 ...
 UiObject brainAppSettingsVibrationFeedback = new UiObject(new UiSelector().text("Vibration"));
 ...
 assertTrue("We should be in the VibrateFeedback now", brainAppFeedbackActivity.exists());
